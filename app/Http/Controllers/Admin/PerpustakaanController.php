...
class PerpustakaanController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $newMembers = User::role('jamaah')->whereBetween('created_at', [$now->copy()->startOfMonth(), $now->copy()->endOfMonth()])->count();
    ...
    public function store(PerpustakaanRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.perpustakaans.index')->with('success', 'Item perpustakaan disimpan.');
    }
    ...
    public function update(PerpustakaanRequest $request, Perpustakaan $perpustakaan): RedirectResponse
    {
        ...
        return redirect()->route('admin.perpustakaans.index')->with('success', 'Item perpustakaan diperbarui.');
    }
    ...
    public function destroy(Perpustakaan $perpustakaan): RedirectResponse
    {
        ...
        return redirect()->route('admin.perpustakaans.index')->with('success', 'Item perpustakaan dihapus.');
    }
    ...
    protected function prepareData(PerpustakaanRequest $request, ?Perpustakaan $perpustakaan = null): array
    {
        ...
        if ($request->hasFile('file_ebook')) {
            ...
            $data['file_ebook'] = $request->string('file_url');
        } elseif ($perpustakaan) {
        ...
        if ($request->hasFile('cover')) {
            ...
            $data['cover'] = $request->string('cover_url');
        } elseif ($perpustakaan) {
