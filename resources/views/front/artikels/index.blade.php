<x-front-layout>
    @php
        ...
        $svg = [
            ...
            'heart'  => '<svg viewBox="0 0 24 24" class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 1 0-7.8z"/></svg>',
        ];
        ...
        // ====== COVER URL (PASTI JALAN) ======
        $fallbackCover = 'https://images.unsplash.com/photo-1493246507139-91e8fad9978e?auto=format&fit=crop&w=1600&q=80';

        $imgUrl = function ($thumb) use ($fallbackCover) {
            if (empty($thumb)) return $fallbackCover;
            ...
            // kalau path sudah kayak "uploads/thumbnails/xxx.jpg"
            $path = ltrim($thumb, '/');
